...
// noTrain pairs are EXCLUDED from every split (labeled with external info the classifier can't
// access; counting them in TEST falsely depresses rec@99). See [[feedback_notrain_and_hidden_exclusion]].
